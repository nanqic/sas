...
import com.shine.model.UserExample.Criteria;
import com.shine.model.UserExample.Criterion;
...
public class UserSqlProvider {
    ...
    public String insertSelective(User record) {
        ...
        if (record.getExperience() != null) {
            sql.VALUES("experience", "#{experience,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(User record) {
        ...
        if (record.getExperience() != null) {
            sql.SET("experience = #{experience,jdbcType=INTEGER}");
        }
